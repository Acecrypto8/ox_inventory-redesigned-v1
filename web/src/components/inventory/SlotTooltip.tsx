...
<div className="tooltip-header-row">
  ...
  <p className="tooltip-item-slot-weight">
    {item.weight > 0
      ? item.weight >= 1000
    ...
    <>
    <div className='tooltip-durrability-bar'>
          <WeightBar percent={item.durability} durability variant="circle" />
      <span className="durability-text-overlay">Item Durability</span>
      <span className="durability-number-overlay">
        {item.durability.toFixed(2)}/100
      </span>
      </div>
    </>
  )}
